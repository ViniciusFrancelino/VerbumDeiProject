...
•	Express.js — servidor web<br>
•	MySQL — Banco de dados local<br>
•	HTML, CSS e JavaScript — desenvolvimento de front<br>
...
•	Configurações — atualização de informações do perfil e senha<br>
<h2>🎯 Objetivo acadêmico:</h2>
O projeto é desenvolvido como parte da disciplina de Pesquisa e Inovação do curso de Análise e Desenvolvimento de Sistemas, com foco na aplicação prática de conceitos aprendidos ao longo do semestre:<br><br>
•	Manipulação de banco de dados<br>
•	Lógica de Programação com Js<br>
•	Arquitetura computacional <br>
•	Virtualização <br>
•	Sistema operacional Linux<br>
•	Organização de código e versionamento com Git/GitHub <br>
